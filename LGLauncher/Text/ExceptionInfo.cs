...
namespace LGLauncher
{
	...
	static class ExceptionInfo
	{
		...
		public static string ExtraText()
		{
			...
			extra.AppendLine();
			extra.AppendLine();
			extra.AppendLine("partNo=【    " + PathList.No + "    】    ( not assigned, if partNo==0.)");
			extra.AppendLine(string.IsNullOrEmpty(PathList.TsName) ? "TsName =" : "TsName = " + PathList.TsName);
			extra.AppendLine();
			extra.AppendLine("------------------------------");
