...
namespace LGLauncher
{
  ...
  internal static class Bat_Join_Logo_Scp
  {
    ...
    /// </summary>
    public static string Make_InRecording(string avsPath, string logoPath, string jl_CmdPath)
    {
      //引数チェック
      ...
      batText = FileR.ReadFromResource("LGLauncher.ResourceText.BaseJoin_Logo_Scp_Rec.bat");
    ...
    /// </summary>
    public static string Make_Last(string jl_CmdPath)
    {
      //引数チェック
      if (File.Exists(jl_CmdPath) == false)
        throw new LGLException("jl_CmdPath does not exist");
      ...
      //bat読込み
      var batText = new List<string>();
      batText = FileR.ReadFromResource("LGLauncher.ResourceText.BaseJoin_Logo_Scp_Last.bat");
